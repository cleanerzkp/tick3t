...
contract EventTicketingTest1 {
    ...
    constructor() {
        eventInfo = EventInfo({
            ...
            photo: "https://static.displate.com/270x380/displate/2021-09-09/acaf2be9f58d1c05de9e4e47c580ee00_0da6a981d11a923cf24cf3f465fa81cc.jpg",  // This would be a real IPFS hash
            n_tickets: 500,
            n_tickets_sold: 0,
            price: 0.01 ether  // 0.1 ETH in wei
        });
    }
